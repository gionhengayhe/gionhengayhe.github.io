...
8.  Similar to upload **post.json**, upload **comment.json** in **raw-data/comment/**.
    ![Cleaned Comment Data](/images/3/4/9.png)
    ![Cleaned Comment Data](/images/3/4/8.png)

That’s how you clean the data using **AWS Lambda** and **EventBridge**. Now, let’s move to the next step: [Create the Data Catalog]({{<ref "4-create-datalog/">}}).
